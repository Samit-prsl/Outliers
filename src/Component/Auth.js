...
export default function Auth(props) {
  ...
  return (
    <div className='container my-10 h-[100vh]'>
      <h1 className='text-2xl my-5'  style={{fontFamily:'Shantell Sans, cursive',fontWeight:'normal'}}>Fashion is not something that exists in dresses only. Fashion is in the sky, in the street, fashion has to do with ideas, the way we live, what is happening.</h1>
